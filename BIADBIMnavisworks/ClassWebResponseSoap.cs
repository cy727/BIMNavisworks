...
{
    class ClassWebResponseSoap
    {
        public static string tagURL = "";
        public static string SOAPAction = "";


        public static string CreateGetHttpResponseSoap(string sFacilityNo) //设备编号
        {
            if(sFacilityNo.Trim()=="")
                return "";
            ...
            try
            {
                ...
                soap.Append("<getJCIInfo xmlns=\"http://tempuri.org/\">");
                soap.Append("<sNo>" + sFacilityNo.Trim() + "</sNo>");
                soap.Append("</getJCIInfo>");
                ...
                XmlReader xmlReader = XmlTextReader.Create(webResponse.GetResponseStream());
        ...
        //asmx=PM25WarnPool 
        public static string CreateGetHttpResponseSoap_byPara(string getURL, string asmxName, string SoapAction)
        {
            ...
            try
            {
                ...
                //soap.Append("<" + asmxName + " xmlns=\"http://tempuri.org/\" /");
                soap.Append("<" + asmxName + " xmlns=\"http://tempuri.org/\" />");
                //soap.Append("</" + asmxName + ">");
